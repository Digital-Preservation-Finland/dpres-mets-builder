...
Changed
^^^^^^^
- Set default fi:METS specification and catalog version to 1.8.0

2.2.0 - 2025-08-19
------------------
Fixed
^^^^^
- Unnecessary metadata wrapper is now automatically removed from
  the Dublin Core descriptive metadata.

2.1.0 - 2025-07-29
------------------
Added
^^^^^
- New ``TechnicalRepresentationObjectMetadata`` class.
- Support for additional identifiers for digital objects.
